    ...
    for f in files:
        ...
        for i in range(len(merged_boxes)):
            ...
            if '/' not in google_name:
                google_name = d2.get(google_name, '')
...
if __name__ == '__main__':
    ...
    ps.add_argument('-i', type=str)
    ps.add_argument('-m', type=str,
        default=MODELS_PATH+'retinanet_resnet50_500_classes_0.4594_converted.h5')

    args = ps.parse_args()

    files_to_process = glob.glob(args.i)
    pretrained_model_path = args.m
